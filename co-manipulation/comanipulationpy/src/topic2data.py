...
class Rostopic2Data:
    ...
    def __init__(self, image_topic, skeleton_topic, robot_topic, flag_topic_start, flag_topic_stop, user_id, tf2_topic, dump_folder='', extra_folder=[],):  
        ...
        self.video_writer = cv2.VideoWriter('{}/{}_video_run_1.avi'.format(self.dump_folder, self.tag), 
                                            fourcc=fourcc, fps=15, frameSize=(1920,1080))
    ...
    def callback(self, skeleton_msg, rgb_msg, robot_msg, flag_msg_start, flag_msg_stop, tf2_msg):
        ...
        if self.stop_flag == True:
            ...
            if Rostopic2Data.runstate == 1:
                ...
                fourcc = cv2.VideoWriter_fourcc(*'MJPG')        #added -fix fourcc error
...
def main(user_id):
    ...
    image_topic = '/front/rgb/image_raw'                #15hz   #works
    ...
    Rostopic2Data(image_topic=image_topic, skeleton_topic=skeleton_topic, robot_topic=robot_topic, flag_topic_start=flag_topic_start, flag_topic_stop=flag_topic_stop, user_id=user_id, tf2_topic = tf2_topic, dump_folder=logdir_path, extra_folder=extra_folder)
